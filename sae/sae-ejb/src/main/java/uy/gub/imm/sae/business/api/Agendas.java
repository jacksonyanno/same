...
public interface Agendas {
	...
	//Crea una copia de la agenda "original" remplazando los atributos por los indicados en aCopiar
	public void copiarAgenda(Agenda original, Agenda aCopiar) throws UserException, ApplicationException, BusinessException;
