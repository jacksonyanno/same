...
public class JRDinamicBeanCollectionDataSource implements JRDataSource {
   ...
   public Object getFieldValue(JRField jrField) throws JRException {
		...
		try {
			...
			//Al nombre del campo le quito el prefijo que le había agregado en el diseño dinamico del reporte para poder encontrar la key en el hash
			value = values.get(jrField.getName().substring(nombreAtributoDeDatosDinamicos.length()+1));
		}
