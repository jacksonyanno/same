...
public class ErrorValidacionException extends ValidacionException {
	 ...
	 */
	public ErrorValidacionException(String codigoError, List<String> nombreCampos, List<String> mensajes) {
	...
	public ErrorValidacionException(String codigoError, List<String> nombreCampos, List<String> mensajes,  List<String> codigosErrorMensajes, String nombreValidacion) {
		super(codigoError,null, nombreCampos, mensajes);
