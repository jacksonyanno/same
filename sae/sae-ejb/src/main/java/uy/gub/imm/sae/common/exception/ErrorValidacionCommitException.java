...
public class ErrorValidacionCommitException extends ValidacionException {
	 ...
	 */
	public ErrorValidacionCommitException(String codigoError, List<String> nombreCampos, List<String> mensajes) {
	...
	public ErrorValidacionCommitException(String codigoError, List<String> nombreCampos, List<String> mensajes,  List<String> codigosErrorMensajes, String nombreValidacion) {
		super(codigoError,null, nombreCampos, mensajes);
