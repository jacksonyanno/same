...
public class SAEProfileMBean extends BaseMBean {
	...
	public String getkaptchaTemplateURL() {
		return String.format(SAEProfile.getInstance().getProperties().getProperty(SAEProfile.PROFILE_UI_TEMPLATES_CAPTCHA_KEY), getProfileHostPort());
	}
