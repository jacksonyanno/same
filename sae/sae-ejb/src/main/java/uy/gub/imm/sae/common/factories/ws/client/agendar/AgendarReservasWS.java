...
public interface AgendarReservasWS {
    ...
    /**
     * 
     * @param cancelarReservasPrevias
     * @param confirmarConWarning
     * @param reserva
     * @return
    ...
    public Reserva confirmarReserva(
        ...
        Reserva reserva,
        @WebParam(name = "cancelarReservasPrevias", targetNamespace = "")
        Boolean cancelarReservasPrevias,
        @WebParam(name = "confirmarConWarning", targetNamespace = "")
        Boolean confirmarConWarning)
