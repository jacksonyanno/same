...
import uy.gub.imm.sae.business.api.AutocompletadosLocal;
import uy.gub.imm.sae.business.api.AutocompletadosRemote;
	...
	public void eliminarAutoCompletado(ServicioAutocompletar a) throws UserException, BusinessException {
		...
		//Se controla que no existan datos asociados vivos para el dato autocompletado.
		 if  (hayDatosVivos(auto)) {
			throw new UserException("AE10030","El servicio autocompletado se encuentra asociado a algun recurso");
		}
