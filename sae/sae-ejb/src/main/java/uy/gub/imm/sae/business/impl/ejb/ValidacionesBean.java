...
import uy.gub.imm.sae.business.api.ValidacionesLocal;
import uy.gub.imm.sae.business.api.ValidacionesRemote;
	...
	public void eliminarValidacion(Validacion v) throws UserException, BusinessException {
		...
		//Se controla que no existan datos asociados vivos para la validacion.
		 if  (hayDatosVivos(validacion)) {
			throw new UserException("AE10030","La validación se encuentra asociada a algun recurso");
		}
